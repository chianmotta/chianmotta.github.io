...
if ((!(params.get('usuario')) || !(params.get('categoria')) || !(params.get('institucion'))) 
    &&
    (!(sessionStorage.getItem('categoria')) || !(sessionStorage.getItem('usuario')) || !(sessionStorage.getItem('institucion')))
){
    ...
    if (sessionStorage.getItem('usuario') && sessionStorage.getItem('usuario')!='null'){
        document.getElementById("spanInfo").innerHTML = `Bienvenido ${sessionStorage.getItem('usuario')} - ${sessionStorage.getItem('institucion')}`
    }
    else{
        ...
        else
        {
            ...
            sessionStorage.setItem('categoria', params.get('categoria'));
            sessionStorage.setItem('institucion', params.get('institucion'));
            params.get('estecnico') ? sessionStorage.setItem('estecnico', params.get('estecnico')) : '';
        }
        document.getElementById("spanInfo").innerHTML = `Bienvenido ${params.get('usuario')} - ${params.get('institucion')}`
    }
